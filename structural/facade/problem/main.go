...
func (iv Inventory) Lookup(name string) (
	*Product, error) {
...
func (acc *Account) Deposit(money float32) {
	acc.balance += money
}
func (acc *Account) Withdraw(money float32) {
	acc.balance -= money
}
...
func (as AccountStorage) Lookup(name string) (
	*Account, error) {
